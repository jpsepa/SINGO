						...
						<div class="panel-body">
							<form role="form" action="ingresa_libro.php" method="post">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input type="text" style="background-color:#c1c1c1;color:#000;text-transform:uppercase" class="form-control" name="identificador" value="<?php echo $numero_ct;?>" readonly>
									</div>
									<br><br><br>
