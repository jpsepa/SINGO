...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="cortadas_canceladas.php"><span class="glyphicon glyphicon-ban-circle"></span> Cortadas Canceladas</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ul class="breadcrumb">
				...
				<li class="active">Cortadas Canceladas</li>
			</ul>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<h2 class="page-header">Cortadas Canceladas DEN y DES</h2>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Cortadas Canceladas del Libro de Acta</div>
					<div class="panel-body">
						<table data-toggle="table" data-url="cortadas_canceladas_array.php" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name">
						    <thead>
						    <tr>
