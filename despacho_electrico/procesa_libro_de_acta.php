...
mysqli_query($link, "INSERT INTO despacho_libro_acta(fecha_inicio, hora_inicio, categoria, km_lugar, den_des, descripcion, notificador, usuario, turno, fecha_hora) VALUES ('$fecha', '$hora_inicio', '".utf8_decode($categoria)."', '".utf8_decode($km_lugar_2)."', '$turno #$den_des', '".utf8_decode($descripcion_2)."', '".utf8_decode($notificador_2)."', '$usuario', '$turno', '$fecha_hora')");
