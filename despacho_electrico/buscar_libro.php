	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<h2 class="page-header">Buscar en Libro de Acta</h2>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">INGRESE RANGO DE BÚSQUEDA</div>
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="busqueda_libro.php" method="post">
								<div class="form-group">
									<label class="col-md-3 control-label" for="name">Desde:</label>
									<div class="col-md-9">
									<input data-provide="datepicker" name="desde" readonly value="<?php echo date("Y-m-d");?>">
									</div>
									<br><br>
									<label class="col-md-3 control-label" for="name">Hasta:</label>
									<div class="col-md-9">
									<input data-provide="datepicker" name="hasta" readonly value="<?php echo date("Y-m-d");?>">
									</div>
									<br><br>
									<div class="col-md-9">
