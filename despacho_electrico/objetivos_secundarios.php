...
$result2=mysqli_query($link, "SELECT descripcion FROM objetivos WHERE id='$id'");
					...
					<div class="panel-body">
						<table data-toggle="table">
						    ...
						    while ($row3 = mysqli_fetch_array($result3)) {
						    	...
						    	<td><a href='editar_objetivo_secundario?id=$id'>&#x270E;</a></td>
						    	</tr>
						    	";
						    }
						    ?>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								do {  	
								?>
          						<option value="<?php echo $row_usuarios['nombre']." ".$row_usuarios['apellido_pat'];?>"><?php echo utf8_encode($row_usuarios['nombre'])." ".utf8_encode($row_usuarios['apellido_pat']);?></option>
          						<?php
