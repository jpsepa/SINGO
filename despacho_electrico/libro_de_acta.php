					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="form-group">
								...
								<input data-provide="datepicker" style="background-color:#fff;color:#000;cursor:pointer" name="fecha" class="form-control" value="<?php echo date("Y-m-d"); ?>">
							</div>								
							<div class="form-group">
								<label>Hora de Inicio</label>
								<input type="text" style="background-color:#fff;color:#000;cursor:pointer" id="hora_inicio" name="hora_inicio" class="hora-control1 form-control" readonly value="<?php echo date("G:i"); ?>">
							...
							<div class="form-group">
								...
								<input style="background-color:#fff;color:#000;text-transform:uppercase" name="km_lugar" class="form-control" placeholder="Ingrese un Kilómetro o Lugar">
							</div>
							<div class="form-group">
								<label>Categoría</label>
								<select class="form-control" style="background-color:#fff;color:#000;cursor:pointer" name="categoria">
 								<?php
							...
							<div class="form-group">
								<label>DEN/DES</label>
								<input style="background-color:#fff;color:#000;text-transform:uppercase" name="den_des" class="form-control" placeholder="Ingrese un DEN/DES. Ej: DEN #450">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input style="background-color:#fff;color:#000;text-transform:uppercase" name="notificador" class="form-control" placeholder="Ingrese el nombre de quien Notifica el hecho">
							</div>
