...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="resumen.php"><span class="glyphicon glyphicon-dashboard"></span> Resumen</a></li>
			<li><a href="despacho_electrico"><span class="glyphicon glyphicon-th"></span> Despacho Eléctrico</a></li>
			<li><a href="operaciones_servicios"><span class="glyphicon glyphicon-th"></span> Operaciones y Servicios</a></li>
			<li><a href="programacion_optimizacion"><span class="glyphicon glyphicon-th"></span> Programación y Optimización</a></li>
			<li><a href="trafico"><span class="glyphicon glyphicon-th"></span> Tráfico</a></li>
			<li><a href="tripulacion"><span class="glyphicon glyphicon-th"></span> Tripulación</a></li>
			<li><a href="Vigilancia"><span class="glyphicon glyphicon-th"></span> Vigilancia</a></li>
			<li><a href="logout.php"><span class="glyphicon glyphicon-user"></span> Desconectarse</a></li>
		</ul>
	</div><!--/.sidebar-->
